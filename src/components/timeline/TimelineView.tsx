...
const TimelineView: React.FC<TimelineViewProps> = ({ systems, plans, highlightedConflicts }) => {
  ...
  // Calculate plans within the current view window for the filter dropdown
  const visiblePlansOptions = useMemo(() => {
  ...
  return (
    <div className="flex flex-col h-full border border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900 overflow-hidden shadow-sm">
      {/* Toolbar */}
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 sticky left-0 z-30 space-y-4">
        ...
        <div className="w-full">
          <Select
            ...
            allowClear
            showSearch
            placeholder="筛选特定计划（仅显示当前视图范围内的计划）"
            className="w-full md:w-1/2"
            value={planFilter}
            onChange={setPlanFilter}
            options={visiblePlansOptions}
